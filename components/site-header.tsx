"use client" // Required for usePathname or state
...
export function SiteHeader({ currentPath = "home/documents/projects", onNavigate  }: SiteHeaderProps) {
      ...
      <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
        ...
        <nav className="flex items-center gap-1 overflow-hidden">
          ...
          <div key="home" className="flex items-center gap-1">
            ...
            {pathSegments.length > 0 && <ChevronRight className="h-4 w-4 text-muted-foreground/50" />}
          </div>

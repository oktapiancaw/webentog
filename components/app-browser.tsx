...
const getFileIcon = (type: FileType) => {
  switch (type) {
    case 'folder':
      return <Folder className="size-5 text-amber-500 fill-amber-500" />;
    case 'image':
      return <ImageIcon className="size-5 text-blue-500" />;
    case 'pdf':
      return <FileText className="size-5 text-red-500 fill-red-500/20" />;
    case 'json':
      return <FileJson className="size-5 text-emerald-500" />;
    case 'video':
      return <Film className="size-5 text-indigo-500 fill-indigo-500/20" />;
    default:
